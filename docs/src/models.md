...
Here we discuss the structure and models used to model generators in `PowerSimulationsDynamics.jl`. See the explanation on Dynamic Devices
in [`PowerSystems.jl`](https://sienna-platform.github.io/PowerSystems.jl/stable/explanation/dynamic_data/) for details.
...
Here we discuss the structure and models used to model inverters in `PowerSimulationsDynamics.jl`. See the explanation on Dynamic Devices
in [`PowerSystems.jl`](https://sienna-platform.github.io/PowerSystems.jl/stable/explanation/dynamic_data/) for details. One of the key contributions in this software package is a separation of the
